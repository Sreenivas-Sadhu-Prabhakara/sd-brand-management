package com.bank.bian.brandmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Brand Plan Management Plan".
 *
 ...
 * to its asset type (Brand Plan). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Brand Plan Management Plan";
